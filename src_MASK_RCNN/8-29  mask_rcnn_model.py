            ...
            if b >= batch_size:
                ...
                if random_rois:
                    ...
                    if detection_targets:
                        ...
                        print('batch_mrcnn_class_ids的shape：',batch_gt_class_ids.shape)
                        print('batch_mrcnn_bbox的shape: ',batch_mrcnn_bbox.shape)
                        print('batch_mrcnn_mask的shape:',batch_mrcnn_mask.shape)
                        d=0
